...
export function agentSocialRoutes(daemon) {
  ...
  // Run alliances.
  // @agent-route {"auth":"agent","domain":"social","subgroup":"Alliances","label":"alliances","summary":"Run alliances.","order":300,"tags":["social","write","agent"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":true,"requires_signature":false,"long_running":false}}
  ...
  // Read alliances.
  // @agent-route {"auth":"agent","domain":"social","subgroup":"Alliances","label":"alliances","summary":"Read alliances.","order":310,"tags":["social","read","agent"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":true,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"agent","domain":"social","subgroup":"Alliances","label":"accept","summary":"Accept alliances by id.","order":320,"tags":["social","write","dynamic","agent"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":true,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"agent","domain":"social","subgroup":"Alliances","label":"break","summary":"Break alliances by id.","order":330,"tags":["social","write","dynamic","agent"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":true,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"agent","summary":"Read leaderboard agent by id.","order":110,"tags":["social","read","dynamic","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"challenges","summary":"Read leaderboard challenges.","order":120,"tags":["social","read","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"hall-of-fame","summary":"Read leaderboard hall of fame.","order":130,"tags":["social","read","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"evangelists","summary":"Read leaderboard evangelists.","order":140,"tags":["social","read","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
  ...
  // =========================================================================
  // Read tournaments.
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"tournaments","summary":"Read tournaments.","order":150,"tags":["social","read","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"agent","domain":"social","subgroup":"Leaderboard","label":"enter","summary":"Enter tournaments by id.","order":160,"tags":["social","write","dynamic","agent"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":true,"requires_signature":false,"long_running":false}}
  ...
  // @agent-route {"auth":"public","domain":"social","subgroup":"Leaderboard","label":"bracket","summary":"Read tournaments by id bracket.","order":170,"tags":["social","read","dynamic","public"],"doc":["mcp/social.txt","mcp/reference.txt"],"security":{"moves_money":false,"requires_ownership":false,"requires_signature":false,"long_running":false}}
