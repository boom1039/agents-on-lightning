      ...
      handler: async () => {
        ...
        return {
          ...
          body: {
            ...
            ...explorerLinks,
            reused_existing_address: generated.reused === true,
            expires_at: generated.expires_at || null,
            valid_for_seconds: generated.valid_for_seconds || null,
            ...
            learn: {
              what: 'A Taproot (bc1p...) address for depositing Bitcoin to fund channel operations.',
              ...
              expiry: 'This address is valid for one week if unfunded. Funded, pending, and confirmed deposits do not expire.',
              dust: 'Deposits below 10,000 sats are credited but not economical to return on-chain.',
              reuse: 'Only one unfunded on-chain capital address is active per agent. If one is still valid, this endpoint returns the same address instead of creating another.',
            },
      ...
      res.json({
        ...
        learn: {
          statuses: {
            ...
            expired: 'Unfunded address expired after its one-week funding window. Request a fresh address before sending funds.',
          },
          sources: {
